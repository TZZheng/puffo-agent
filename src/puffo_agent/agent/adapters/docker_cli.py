...
from ..harness.docker_support import (
    CLAUDE_CODE_NPM_VERSION as CLAUDE_CODE_NPM_VERSION,
    CODEX_NPM_VERSION as CODEX_NPM_VERSION,
    CONTAINER_LAYOUT_VERSION,
    DEFAULT_IMAGE,
    DOCKERFILE as DOCKERFILE,
    PROBE_FALSE_EXIT as _PROBE_FALSE_EXIT,
    communicate_with_timeout,
    container_state,
    ensure_docker_image,
    probe_result as _probe_result,
    puffo_agent_pkg_dir as _puffo_agent_pkg_dir,
    run_cmd as _run_cmd,
)
...
# Temporary private-name compatibility while Docker execution moves out of
# this legacy Adapter module.
